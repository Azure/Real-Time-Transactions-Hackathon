...
namespace account_generator
{
    public partial class Program
    {
        ...
        public static async Task MainAsync(string[] args)
        {
            ...
            //       Use the "payments" database and "transactions" and "members" containers.
            //transactionsContainer = ________;
            //membersContainer = ________;
        ...
        static async Task CreateMembersAsync()
        {
            ...
            // TODO: Write a SELECT query to count the number of documents in the Members container.
            ...
            for (var i = 0; i <= 10; i++)
            {
                ...
                {
                    var newMember = memberFaker.Generate();
                    // TODO: Finish the code below to create the new Member item in the Members container.
                    //       Set the partition key to the memberId.
                    //await ________;
                });
            }
